...
public class Imgproc {
    ...
    public static void Canny(Mat image, Mat edges, double lowerThreshold, double upperThreshold)
    {
        
        Canny_1(image.nativeObj, edges.nativeObj, lowerThreshold, upperThreshold);
