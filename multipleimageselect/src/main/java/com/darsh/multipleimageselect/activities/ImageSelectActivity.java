...
public class ImageSelectActivity extends HelperActivity {
    ...
    private TextView errorDisplay, txtCount;
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (countSelected > 0) {
                    ...
                    Toast.makeText(getApplicationContext(), getString(R.string.image_view), Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    private void toggleSelection(int position) {
        if (!images.get(position).isSelected && countSelected >= Constants.limit) {
            Toast.makeText(
                    ...
                    String.format(getString(R.string.limit_exceeded),
                            Constants.limit), Toast.LENGTH_SHORT).show();
            return;
        }
