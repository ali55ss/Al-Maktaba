...
public class MediaController {
    ...
    private static boolean isdeleteFile;
    ...
    public static class VideoConvertRunnable implements Runnable {
        ...
        @Override
        public void run() {
            MediaController.getInstance().convertVideo(videoPath,outputPath,isdeleteFile);
        }
    }
    ...
    @TargetApi(16)
    public boolean convertVideo(final String path,final String outputfilePath, boolean isDelete) {
        ...
        //File cacheFile = new File(outputfilePath);
