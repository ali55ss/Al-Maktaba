...
final public class SharedPrefsUtils {
    ...
    /**
     * Helper method to remove a value to {@link SharedPreferences}.
     *
     * @param context a {@link Context} object.
     * @param key
     * @return true if the value was successfully remove from persistent storage.
     */
    ...
    /**
     * Helper method to remove all values to {@link SharedPreferences}.
     *
     * @param context a {@link Context} object.
     * @return true if the value was successfully remove from persistent storage.
     */
