...
public class BallPulseRiseIndicator extends Indicator {
    ...
    public void draw(Canvas canvas, Paint paint) {
        ...
        canvas.drawCircle(radius,getHeight()-3*radius,radius,paint);
        canvas.drawCircle(getWidth()/2,getHeight()-3*radius,radius,paint);
        canvas.drawCircle(getWidth()-radius,getHeight()-3*radius,radius,paint);
    }
